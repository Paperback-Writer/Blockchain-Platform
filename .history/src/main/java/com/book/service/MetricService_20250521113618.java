...
public class MetricService {
    ...
    private void initializeChartInfo() {
        ...
        addChartInfo("Block Size", "static", Arrays.asList(
            new ChartInfo("Block Size Heatmap", "/static/images/charts/block_size_heatmap.png", "Shows the distribution of block sizes across different time periods, with red areas indicating larger block sizes."),
            new ChartInfo("Block Size Box Plot", "/static/images/charts/block_size_boxplot.png", "Shows statistical distribution characteristics of block sizes, including median, quartile ranges, and outliers.")
        ));
        
        // Correlation between Fee and Amount
        addChartInfo("Transaction Fees", "static", Arrays.asList(
            new ChartInfo("Transaction Fee and Amount Correlation Bar Chart", "/static/images/charts/fee_amount_bar.png", "Shows average transaction fees for different amount ranges."),
            new ChartInfo("Transaction Fee Distribution Pie Chart", "/static/images/charts/fee_pie.png", "Shows the proportion of transactions at different fee levels."),
            new ChartInfo("Transaction Fee and Amount Scatter Plot", "/static/images/charts/fee_amount_scatter.png", "Shows the relationship between fees and amounts for each transaction, reflecting correlation strength.")
        ));
        
        // Fund Flow
        addChartInfo("Fund Flow", "static", Arrays.asList(
            new ChartInfo("Fund Flow Proportion Chart", "/static/images/charts/fund_flow_ratio.png", "Shows the proportion of fund flows between different types of addresses."),
            new ChartInfo("Fund Flow Network Graph", "/static/images/charts/fund_flow_network.png", "Visualizes the fund flow network and relationship strength between major addresses.")
        ));
        
        // Gini Index
        addChartInfo("Gini Index", "static", Arrays.asList(
            new ChartInfo("Wealth Distribution Heatmap", "/static/images/charts/gini_heatmap.png", "Shows the distribution of addresses across different amount ranges."),
            new ChartInfo("Address Balance Distribution Bar Chart", "/static/images/charts/gini_bar.png", "Shows address counts by balance level, displaying wealth concentration.")
        ));
        
        // Mirco Velocity
        addChartInfo("Micro Velocity", "static", Arrays.asList(
            new ChartInfo("Micro Velocity Bar Chart", "/static/images/charts/micro_velocity_bar.png", "Shows micro transaction velocity statistics within different time windows.")
        ));
        
        // Inflation
        addChartInfo("Inflation", "static", Arrays.asList(
            new ChartInfo("Inflation Rate Time Series", "/static/images/charts/inflation_time.png", "Shows the trend of inflation rate changes over time.")
        ));
        
        // Trade-offs Analysis
        addChartInfo("Rewards", "static", Arrays.asList(
            new ChartInfo("Triangular Trade-off Radar Chart", "/static/images/charts/tradeoff_radar.png", "Uses a radar chart to show the trade-off relationship between security, decentralization, and performance.")
        ));
        
        // Transaction Throughput
        addChartInfo("Transaction Throughput", "static", Arrays.asList(
            new ChartInfo("Transaction Throughput Gauge Chart", "/static/images/charts/throughput_gauge.png", "Uses a gauge chart to show the comparison between current network transaction processing capacity and design limits.")
        ));
        
        // Market Cap and P/E Ratio
        addChartInfo("Market Cap and P/E Ratio", "static", Arrays.asList(
            new ChartInfo("Market Cap and P/E Ratio Data Table", "/static/images/charts/marketcap_table.png", "Displays current market cap and P/E ratio data in table format.")
        ));
    }
