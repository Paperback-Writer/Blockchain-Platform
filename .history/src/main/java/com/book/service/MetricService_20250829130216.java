...
public class MetricService {
    ...
    private void initializeMetricDescriptions() {
        ...
        metricDescriptions.put("Utxo Active Rate", "Assessing network activity through UTXO-based active rate analysis across cryptocurrency ecosystems.");
        metricDescriptions.put("Balance VS Mining Concentration", "Analyzing cryptocurrency decentralization patterns through balance and mining concentration metrics across major digital assets.");
        metricDescriptions.put("Cross-chain Economic Feature Comparison", "Conducting multi-dimensional economic analysis of cryptocurrency networks using normalized radar chart visualization.");
        metricDescriptions.put("Gini Coefficient", "Measuring wealth inequality distribution across cryptocurrency networks using Gini coefficient analysis.");
        metricDescriptions.put("Mining Reward Concentration", "Analyzing mining power centralization across cryptocurrency networks by measuring reward concentration among top mining entities.");
        metricDescriptions.put("Top 1 Ratio", "Evaluating wealth concentration in cryptocurrency networks by calculating the balance share held by the top 1% of addresses. ");
        metricDescriptions.put("Whale Ratio", "Investigating large-holder dominance by measuring the share of total supply controlled by whale addresses in cryptocurrency networks.");
    }
    ...
    private void initializeChartInfo() {
        ...
        addChartInfo("Transaction Fees", "static", Arrays.asList(
            ...
            new ChartInfo("Transaction Fee and Amount Scatter Plot", "Scatterplot.png",
        ...
        // Cluster - Balance VS Mining Concentration
        addChartInfo("Balance VS Mining Concentration", "cluster", Arrays.asList(
            new ChartInfo("BM Overview", "balance_vs_mining_concentration.png", "Balance VS Mining Concentration")
        ));
        ...
        // Cluster - Mining Reward Concentration
        addChartInfo("Mining Reward Concentration", "cluster", Arrays.asList(
            new ChartInfo("MV Overview", "mining_reward_concentration.png", "mining rewardconcentration")
        ));
        ...
        addChartInfo("Whale Ratio", "cluster", Arrays.asList(
            new ChartInfo("WR Trend", "whale_ratio.png", "Whale ratio trend")
        ));
}
