...
public class MetricService {
    ...
    private void initializeMetricDescriptions() {
        ...
        metricDescriptions.put("Balance VS Mining Concentration", "Balance VS Mining Concentration");
        ...
        metricDescriptions.put("Mining Reward Concentration", "Mining Reward Concentration");
