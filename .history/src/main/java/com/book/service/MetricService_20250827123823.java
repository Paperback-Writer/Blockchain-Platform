...
public class MetricService {
    ...
    private void initializeChartInfo() {
        ...
        addChartInfo("Block Size", "static", Arrays.asList(
            ...
            new ChartInfo("Block Size Box Plot", "Boxplot.png",
        ...
        addChartInfo("Micro Velocity", "static", Arrays.asList(
            new ChartInfo("Micro Velocity Bar Chart", "micro_velocity_bar.png",
                "Shows micro transaction velocity statistics within different time windows.")
        ));

        // Inflation
        addChartInfo("Inflation", "static", Arrays.asList(
            new ChartInfo("Inflation Rate Time Series", "inflation_time.png",
                "Shows the trend of inflation rate changes over time.")
        ));

        // Rewards (Trade-offs)
        addChartInfo("Rewards", "static", Arrays.asList(
            new ChartInfo("Triangular Trade-off Radar Chart", "tradeoff_radar.png",
                "Uses a radar chart to show the trade-off relationship between security, decentralization, and performance.")
        ));

        // Transaction Throughput
        addChartInfo("Transaction Throughput", "static", Arrays.asList(
            new ChartInfo("Transaction Throughput Gauge Chart", "throughput_gauge.png",
        ...
        addChartInfo("Market Cap and P/E Ratio", "static", Arrays.asList(
            new ChartInfo("Market Cap and P/E Ratio Data Table", "marketcap_table.png",
                "Displays current market cap and P/E ratio data in table format.")
        ));
    }
