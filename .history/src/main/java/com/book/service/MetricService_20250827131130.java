...
public class MetricService {
    ...
    private void initializeChartInfo() {
        ...
        addChartInfo("Micro Velocity", "static", Arrays.asList(
            new ChartInfo("Holding Time", "Barchart.png",
                "Shows micro transaction velocity statistics within different time windows."),
            new ChartInfo("UTXO over Time", "Timeseries.png",
                "Shows micro transaction velocity statistics within different time windows.")
        ));
        ...
        addChartInfo("Utxo Active Rate", "cluster", Arrays.asList(
            new ChartInfo("UAR Heatmap", "UAR_Heatmap.png", "Heatmap of UTXO activity across chains"),
            new ChartInfo("UAR Distribution", "UAR_Distribution.png", "Distribution of UTXO active rate")
        ));
        ...
        addChartInfo("Daily Coin Destroyed", "cluster", Arrays.asList(
            ...
            new ChartInfo("DCD Boxplot", "DCD_Boxplot.png", "Distribution characteristics")
        ));
        ...
        addChartInfo("Cross-chain Economic Feature Comparison", "cluster", Arrays.asList(
            new ChartInfo("CEC Radar", "CEC_Radar.png", "Radar of cross-chain economic features"),
            new ChartInfo("CEC Heatmap", "CEC_Heatmap.png", "Heatmap of feature comparison")
        ));

        // Cluster - Gini Coefficient
        addChartInfo("Gini Coefficient", "cluster", Arrays.asList(
            new ChartInfo("GC Trend", "GC_Trend.png", "Gini coefficient trend"),
            new ChartInfo("GC Comparison", "GC_Comparison.png", "Cross-chain comparison")
        ));

        // Cluster - Micro Velocity
        addChartInfo("Micro Velocity", "cluster", Arrays.asList(
            new ChartInfo("MV Overview", "MV_Overview.png", "Overview of micro velocity"),
            new ChartInfo("MV Distribution", "MV_Distribution.png", "Distribution of MV")
        ));

        // Cluster - Top 1 Ratio
        addChartInfo("Top 1 Ratio", "cluster", Arrays.asList(
            new ChartInfo("T1R Trend", "T1R_Trend.png", "Top 1 ratio trend"),
            new ChartInfo("T1R Comparison", "T1R_Comparison.png", "Cross-chain comparison")
        ));
